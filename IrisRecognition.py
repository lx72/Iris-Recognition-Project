...
trainNames = ['CASIA Iris Image Database (version 1.0)/' + '{0:03d}'.format(ppl) + '/1/' + '{0:03d}'.format(ppl) + '_1_'  for ppl in list(range(1, 109))]
...
testNames = ['CASIA Iris Image Database (version 1.0)/' + '{0:03d}'.format(ppl) + '/2/' + '{0:03d}'.format(ppl) + '_2_'  for ppl in list(range(1, 109))]
